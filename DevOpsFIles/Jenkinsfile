...
// echo "Build number is:  ${env.BUILD_NUMBER}"
 ...
 stage('CheckoutCode')
 {
  git branch: 'development', credentialsId: '91ad3536-8f9f-4983-85d9-daf832f30b35', url: 'https://github.com/p2pro-DevOps/maven-web-application.git'
 }
  ...
  */
  ...
  Regards,
  P2pro Technologies,
  9491442131''', cc: 'areddy121314@gmail.com', from: '', replyTo: '', subject: 'Build is over..', to: 'p2protech@gmail.com,anuroop.rv@gmail.com'
  }
